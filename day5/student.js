...
function readFormData() {
  ...
  formData["studentCollege"] = document.getElementById("studentCollege").value;
...
function insertNewRecord(data) {
  ...
  cell2.innerHTML = data.studentCollege;
...
document.getElementById("studentCollege").value=selectedRow.cells[1].innerHTML;
...
selectedRow.cells[1].innerHTML=formData.studentCollege;
...
// var  b = document.getElementById("studentCollege").value;
